...
class Test(ttk.Labelframe):
    ...
    def __init__(self, master, text="TEST LISTBOX", *args, **kwargs):
        ...
        self.lb = wc.LabelInput(
            ...
            disable_vars=[self._vars["test1"], self._vars["disable"]]
        )
